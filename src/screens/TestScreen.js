...
const Test = ({ route, navigation }) => {
    ...
    const addScore = () => {
        navigation.navigate('ListTest'); restartQuiz()
    };
    ...
    const getLession = async () => {
        try {
            const response = await fetch(`${BASE_URL}/question-by-test/${itemId}`);
    ...
    return (
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                {/* ProgressBar */}
                {renderProgressBar()}
                <Image source={require('../../assets/images/item4_home_list.png')} style={{ width: 90, height: 90, marginTop: 30 }}></Image>
                {/* Question */}
                {renderQuestion()}
                ...
                >
                    <View style={{
                        ...
                        <View style={{
                            ...
                            {/* Retry Quiz button */}
                            <TouchableOpacity
                                onPress={() => { addScore(); addHistory(score) }}
                                style={{
                                    backgroundColor: '#3498db',
